...
<nav>
  ...
  <ul><li>Home</li><li>Services</li><li>Portfolio</li><li>Contact us</li></ul>
  </nav>
...
{watch[activePiece].matieres.map(
  (m,i)=>{
    return(
      <div style={{border:activeMat == i?"2px solid black":null }} onClick={()=>setActiveMat(i)}>{m.matName} </div>
    )
  }
)}
...
<div><div className="title">Coleur</div>
{/* <div className="title_secondary">Aqua blue</div> */}
<div className="type_list">
{watch[activePiece].matieres[activeMat].colors?.map(
  (c)=>{
    return(
      <div style={{backgroundColor:c}} className="type_list_item"></div>
    )
  }
)}
</div></div>
<div><div className="title">Textures</div>
{/* <div className="title_secondary">Aqua blue</div> */}
<div className="type_list">
{watch[activePiece].matieres[activeMat].textures?.map(
  (t)=>{
    return(
      <div style={{width:'100%'}}><h4 style={{color:"gray"}}>{t}</h4><br></br></div>
    )
  }
)}
</div></div>
...
<button className="content_bottom_button" onClick={()=>setActivePiece(0)}>Centure</button>
<button className="content_bottom_button" onClick={()=>setActivePiece(1)}>dora</button>
<button className="content_bottom_button" onClick={()=>setActivePiece(2)}>Dial</button>
